...
public class ObjectFactory {
    ...
    private final static QName _GetAllUsers_QNAME = new QName("http://service.spring.demo/", "getAllUsers");
    private final static QName _GetAllUsersResponse_QNAME = new QName("http://service.spring.demo/", "getAllUsersResponse");
    private final static QName _GetUserById_QNAME = new QName("http://service.spring.demo/", "getUserById");
    private final static QName _GetUserByIdResponse_QNAME = new QName("http://service.spring.demo/", "getUserByIdResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.spring.demo/", name = "getAllUsers")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.spring.demo/", name = "getAllUsersResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.spring.demo/", name = "getUserById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.spring.demo/", name = "getUserByIdResponse")
