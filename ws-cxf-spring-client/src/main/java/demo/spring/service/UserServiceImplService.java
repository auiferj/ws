 ...
 * 2017-05-23T06:14:58.022+08:00
 * Generated source version: 3.1.11
 * 
 */
@WebServiceClient(name = "UserServiceImplService", 
                  wsdlLocation = "http://localhost:8080/ws-cxf-spring/webservice/userWS?wsdl",
                  targetNamespace = "http://service.spring.demo/") 
public class UserServiceImplService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://service.spring.demo/", "UserServiceImplService");
    public final static QName UserServiceImplPort = new QName("http://service.spring.demo/", "UserServiceImplPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/ws-cxf-spring/webservice/userWS?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UserServiceImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/ws-cxf-spring/webservice/userWS?wsdl");
        }
        WSDL_LOCATION = url;
    }
